...
async function sendRegistrationEmail(userEmail, name) {
  ...
  const html = `<p>Hello ${name}</p><p>Thank you for registering at Banking System. We're exicted to have you on board!</p><p>Best regards,<br />The Banking System Team</p>`;
